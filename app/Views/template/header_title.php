...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
        <div class="container">
            ...
            <a class="navbar-brand" href="<?php echo base_url() ?>">La/Micha</a>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="<?php echo base_url('listar_productos') ?>#portfolio">Productos</a></li>
                    <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="<?php echo base_url('verCarrito') ?>"><i class="fa-solid fa-cart-shopping"></i><span id="num_cart" name="num_cart" class="badge bg-secondary">
                    ...
                    <li class="nav-item mx-0 mx-lg-1 dropdown">
                        <a class="nav-link py-3 px-0 px-lg-3 rounded dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <span class="badge bg-secondary"><?php $user = session()->get('user');if ($user != null) {echo $user;} else {echo 'INICIA/REGISTRATE';} ?></span>
                        </a>
